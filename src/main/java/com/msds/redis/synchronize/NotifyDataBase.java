...
public class NotifyDataBase extends JedisPubSub {
	...
	public void onMessage(String channel, String sql) {
		...
		System.out.print("---->-test-★-0-NotifyDataBase.java-onMessage(...)--:"+ redisCacheManager +"\n" ); //
		System.out.print("---->-test-1-NotifyDataBase.java-onMessage(...)--:"+ redisCacheManager.getRedisPoolMap() +"\n" ); //
